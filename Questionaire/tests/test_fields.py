...
class FieldsTestCase(TestCase):
    ...
    def test_ignorable(self):
        ...
        for field in fields:
            self.assertValidates(field, field.widget.value_from_datadict(
                {'something_else': 'an_answer', get_ignorable_name(field): '1'},
                {}, field.name))
    ...
    def assertValidates(field, value):
        ...
        try:
            ...
            raise AssertionError("{value} was not deemed valid: {error}".
                                 format(value=result, error=e.message))
...
# Todo: Test initial data on fields